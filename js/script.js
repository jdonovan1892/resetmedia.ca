...
jQuery(document).ready(function(){
  $('#info').click(function(){
    $('body').addClass('rst-right-active');
    $('.sub_overlay').addClass('visible');
  });
  $('.close-icon').click(function(){
    $('body').removeClass('rst-right-active');
    $('.sub_overlay').removeClass('visible');
  });
});
...
(function() {
    ...
    function initHeader() {
        ...
        largeHeader = document.getElementById('leftSide');
        largeHeader.style.height = height+'px';

        canvas = document.getElementById('rst-network');
        canvas.width = width;
